...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("mandarbavdane@gmail.com");
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I have specialize in, JavaScript/TypeScript with a focus on
                React and Next.jsx ecosystems.
              </p>
            </div>
          </div>
        </div>
